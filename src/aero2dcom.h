...
const int INV=0,LAM=1,SA=2,KE=3,SST=4,INCOM=0,COM=1,WF=0,LR=1,ALLFIX=0,VINPOUT=1,SIMPLE=0,SIMPLEC=1,FUP=0,SUP=1,QUICK=2,TVD=3,CDS=4,
SORGS=0,PBICG=1,FIXED=0,FLUX=1,CTYPE=0,OTYPE=1,INITBC=0,INITFILE=1,INITMEM=2;
extern bool pntctrlflag,energyflag,visheatflag,stagflag,matairflag;
